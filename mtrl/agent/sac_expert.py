...
class Agent(AbstractAgent):
    ...
    def __init__(
        ...
        self.master_agent = hydra.utils.instantiate(
    ...
    def update_actor_and_alpha(
        ...
        if use_expert:
            mu_e, pi_e, log_pi_e, log_std_e,mask = self.actor.forward_expert(mtobs=mtobs, detach_encoder=True,expert_id=expert_id,relabel_id=relabel_id)
